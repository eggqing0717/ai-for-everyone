...
![自回归生成：像文字接龙一样一个字一个字往下写](../assets/images/ch19-autoregressive.png)

> 🎨 生图提示词：自回归生成示意图，教学插画风格，中文标注。横向展示文字接龙过程："今天天气"→"今天天气真"→"今天天气真好"，每一步用箭头连接，新增的字用高亮色突出，末尾画一个循环回箭头表示"重复这个过程"。旁边配一个可爱机器人像玩接龙一样举着字牌。配色活泼友好。
...
![模型规模膨胀与涌现能力](../assets/images/ch19-emergence.png)

> 🎨 生图提示词：涌现能力示意图，教学插画风格，中文标注。用"烧水"作主视觉：横轴为"模型规模/参数量"，纵轴为"能力"，曲线在前半段平缓、到某临界点后陡然跃升；临界点处画一壶正在沸腾冒泡的水，气泡上标注"推理、翻译、写代码"等突然出现的能力。配色明快，直观表达"量变到质变"。
