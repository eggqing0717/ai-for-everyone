...
![注意力机制：处理每个词时动态关注句子里的相关词](../assets/images/ch17-attention-focus.png)

> 🎨 生图提示词：一张注意力聚焦示意图，教学插画风格，中文标注。画一句话"我最爱吃家乡的米粉"排成一行词块，当前处理的词"米粉"高亮，从它引出粗细不同的箭头指向前面的词，指向"家乡""南方"的箭头很粗（关注度高），指向"我""的"的箭头很细（关注度低）。用箭头粗细直观表达"关注度分配"。配色明快友好。
...
![自注意力：句子里每个词都关注其他所有词](../assets/images/ch17-self-attention.png)

> 🎨 生图提示词：一张自注意力关系网示意图，教学插画风格，中文标注。把一句话"小明把书递给小红因为他读完了"的每个词排成一圈或一行词块，词与词之间用交织的连线相连，"他"与"小明"之间的连线特别粗特别亮，表示强关联；其他连线较细。整体像一张互相张望的关系网，配色清爽，突出"每个词都在看其他词"的感觉。
