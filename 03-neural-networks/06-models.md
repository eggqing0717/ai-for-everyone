...
![经典模型门派对比](../assets/images/ch14-models-overview.png)

> 🎨 生图提示词：一张"武林门派"风格的合影海报，四个拟人化的卡通角色分别代表 VGG（憨厚的堆积木工人）、Inception（拿着多个不同焦距镜头的摄影师）、ResNet（在高速公路上飞驰、身形超高象征层数深）、YOLO（眼疾手快的快枪手，配文"只看一眼"）。每个角色下方标注模型名和一句话特点。蓝紫科技风，扁平卡通插画，中文标注。
