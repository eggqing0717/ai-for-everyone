...
![好提示词与差提示词对照示意](../assets/images/ch20-prompt-comparison.png)

> 🎨 生图提示词：左右分屏对照图，左侧红色区域标"差提示词"，一个人只说一句模糊的话，AI 输出一团乱麻；右侧绿色区域标"好提示词"，一个人给出"角色+任务+约束+示例"四个清晰卡片，AI 输出整齐漂亮的结果。扁平插画风，中文标注，红绿对比配色，简洁教学风。
...
![提示词万能模板结构](../assets/images/ch20-prompt-template.png)

> 🎨 生图提示词：一张四层积木堆叠图，从下到上依次为"角色""任务""约束""示例"四块彩色积木，每块标注对应说明文字，顶部一个 AI 机器人图标接收成品。蓝橙渐变，中文标注，卡通积木风格，简洁明了。
