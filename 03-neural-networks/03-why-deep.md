...
![深度网络分层提取特征](../assets/images/ch11-feature-hierarchy.png)

> 🎨 生图提示词：一张从左到右四栏递进的示意图，展示深度网络如何逐层理解人脸。第一栏"像素点"（杂乱的彩色小方块），第二栏"边缘线条"（黑白线条轮廓），第三栏"局部器官"（单独的眼睛、鼻子、嘴），第四栏"完整人脸"（清晰的人脸轮廓）。栏与栏之间用向右的箭头连接，下方标注"从具体到抽象"。蓝紫科技风，扁平教学插画，中文标注。
