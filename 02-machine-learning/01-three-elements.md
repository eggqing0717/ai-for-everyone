...
![数据、模型、训练三角关系](../assets/images/ch04-three-elements.png)

> 🎨 生图提示词：一个等边三角形示意图，三个顶点分别是"数据（画一个粮仓/一堆食材图标）""模型（画一个齿轮/大脑图标）""训练（画一个循环箭头/举哑铃的小人图标）"，三个顶点用双向箭头相互连接，中间写"缺一不可"四个字，扁平化教学插画风，配色明亮温暖（橙、蓝、绿），全部中文标注。
