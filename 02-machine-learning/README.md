...
![机器学习学习路线图](../assets/images/ch04-ml-roadmap.png)

> 🎨 生图提示词：一张横向的学习路线图插画，从左到右五个圆形站点依次是"数据""模型""训练""评估""应用"，每个站点配一个可爱的小图标（如粮仓、齿轮、跑步小人、放大镜、火箭），站点之间用弯曲的小路和脚印连接，背景是明亮的蓝绿渐变，扁平化教学插画风格，全部中文标注，风格温暖亲切。
